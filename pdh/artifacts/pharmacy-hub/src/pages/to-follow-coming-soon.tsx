...
export default function ToFollowComingSoon() {
  return (
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Generate owed-medication slips digitally and replace the physical
              ordering book — built for busy dispensaries.
            </p>
          </div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-foreground/85">
                      Quickly capture patient details, medications owed, and
                      reason — no paper forms needed.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                    <span className="text-sm text-foreground/85">
                      Automatically notify the purchasing team by email when a
                      to-follow slip is raised.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                    <span className="text-sm text-foreground/85">
                      Digital audit trail — view, search, and resolve outstanding
                      owed items from a central dashboard.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Clock className="w-5 h-5 text-muted-foreground shrink-0 mt-0.5" />
                    <span className="text-sm text-muted-foreground">
                      Printable slip output for handing to patients, compliant
