          ...
          <nav className="hidden lg:flex items-center gap-8 shrink-0 justify-self-center">
            ...
            <DropdownMenu open={toolsOpen} onOpenChange={setToolsOpen}>
              ...
              >
                ...
                <DropdownMenuSub>
                  <DropdownMenuSubTrigger className="rounded-md p-3 cursor-pointer gap-4 focus:bg-primary/5 data-[state=open]:bg-primary/5 transition-colors group mt-1 [&>svg]:hidden">
                    ...
                    <div className="flex-1 flex items-center justify-between">
                      <div>
                        <div className="font-semibold text-sm text-foreground">Patient Information Leaflets</div>
                      </div>
                ...
                <Link href="/tools/to-follow-slips">
                  <DropdownMenuItem className="rounded-md p-3 cursor-pointer gap-4 focus:bg-muted/10 mt-1 transition-colors group">
                    <div className="w-10 h-10 rounded-full bg-muted/60 text-foreground flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest px-4 pt-3 pb-1 flex items-center gap-1.5">
                        <Pill className="w-3 h-3" /> Patient Information Leaflets
                      </div>
                      <SheetClose asChild>
                        <Link
                      ...
                      <SheetClose asChild>
                        <Link
                          href="/tools/to-follow-slips"
                          className="flex items-center gap-4 p-3 rounded-md hover:bg-muted/40 transition-colors mt-1"
                        >
                          <div className="w-10 h-10 rounded-full bg-muted/60 text-foreground flex items-center justify-center shrink-0">
